...
public class pointAdapter_31 extends InfoWindow.DefaultViewAdapter
{
    private final Context mContext;
    private final ViewGroup mParent;

    public pointAdapter_31(@NonNull Context context, ViewGroup parent)
    {
        super(context);
        mContext = context;
        mParent = parent;
    ...
    protected View getContentView(@NonNull InfoWindow infoWindow)
    {
        ...
        txtTitle.setText("공대운동장");
        imagePoint.setImageResource(R.drawable.point_img31);
