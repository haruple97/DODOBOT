...
public class pointAdapter_33 extends InfoWindow.DefaultViewAdapter
{
    private final Context mContext;
    private final ViewGroup mParent;

    public pointAdapter_33(@NonNull Context context, ViewGroup parent)
    {
        super(context);
        mContext = context;
        mParent = parent;
    ...
    protected View getContentView(@NonNull InfoWindow infoWindow)
    {
        ...
        txtTitle.setText("농장관리사");
        imagePoint.setImageResource(R.drawable.point_img32);
