...
public class pointAdapter_17 extends InfoWindow.DefaultViewAdapter
{
    private final Context mContext;
    private final ViewGroup mParent;

    public pointAdapter_17(@NonNull Context context, ViewGroup parent)
    {
        super(context);
        mContext = context;
        mParent = parent;
    ...
    protected View getContentView(@NonNull InfoWindow infoWindow)
    {
        ...
        txtTitle.setText("교수학습개발센터");
        imagePoint.setImageResource(R.drawable.point_img17);
        txtAddr.setText("https://ctl.daegu.ac.kr/main.php");
        txtTel.setText("학습법) 053-850-5540");
