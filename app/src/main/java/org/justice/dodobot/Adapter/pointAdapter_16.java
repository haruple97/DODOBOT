...
public class pointAdapter_16 extends InfoWindow.DefaultViewAdapter
{
    private final Context mContext;
    private final ViewGroup mParent;

    public pointAdapter_16(@NonNull Context context, ViewGroup parent)
    {
        super(context);
        mContext = context;
        mParent = parent;
    ...
    protected View getContentView(@NonNull InfoWindow infoWindow)
    {
        ...
        txtTitle.setText("대구사이버대학교");
        imagePoint.setImageResource(R.drawable.point_img16);
        txtAddr.setText("경산북도 경산시 진량읍\n대구대로 201 (38453)");
        txtTel.setText("053-859-7500");
