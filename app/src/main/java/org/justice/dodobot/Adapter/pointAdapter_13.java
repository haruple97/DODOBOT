...
public class pointAdapter_13 extends InfoWindow.DefaultViewAdapter
{
    private final Context mContext;
    private final ViewGroup mParent;

    public pointAdapter_13(@NonNull Context context, ViewGroup parent)
    {
        super(context);
        mContext = context;
        mParent = parent;
    ...
    protected View getContentView(@NonNull InfoWindow infoWindow)
    {
        ...
        txtTitle.setText("사범대학 2호관");
        imagePoint.setImageResource(R.drawable.point_img13);
        txtAddr.setText("투철한 사명감과 건전한 인격을 갖춘\n민주적이고 창의적인 교사 양성");
        txtTel.setText("053-850-4100");
